...
order: 9
description: "Why the market hunts stop losses."
illustration: "LiquiditySweepVisual"
time: 12
difficulty: "Intermediate"
tools: ["chart"]
objectives:
  - "Master the advanced mechanics of what is liquidity?"
  - "Identify deep liquidity signatures in the live market"
  - "Formulate trade execution plans based strictly on probability"
quiz:
  - question: "What is the core institutional purpose of What is Liquidity??"
  ...
  - question: "When analyzing What is Liquidity?, what confirms its validity?"
  ...
  - question: "A common retail trap regarding What is Liquidity? is:"
    ...
    correct: 1
    explanation: "Retail traders often fail to align What is Liquidity? with the higher timeframe narrative."
  - question: "How does What is Liquidity? relate to liquidity?"
    ...
    correct: 1
    explanation: "What is Liquidity? processes are almost always tied directly to engineering or consuming liquidity pools."
  - question: "The best tool for confirming What is Liquidity? is:"
...
## Introduction to What is Liquidity?

Why the market hunts stop losses. This advanced concept separates the professionals from the retail speculators. By studying the true footprint of algorithmic delivery, you begin to trade alongside the institutions rather than against them.
...
Trading What is Liquidity? requires absolute discipline. You must wait for the exact parameters of your system to align within the correct time window (Killzone). A [[Liquidity Sweep|hunt for stop losses]] is often the pre-cursor to the real move.
